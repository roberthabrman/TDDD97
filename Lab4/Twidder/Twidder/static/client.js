...
function dragStart(event) {
    event.dataTransfer.setData("emaildrag", event.target.id);//sets the dragged item to "emaildrag"
}
...
function drop(event) {
    event.preventDefault();
    var data = event.dataTransfer.getData("emaildrag");//fetches the data that the item with id emaildrag has
    event.target.value = document.getElementById(data).innerHTML;//sets the target to whatever was in the dragged object
}
